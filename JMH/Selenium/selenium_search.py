...
def main():
    ...
    # 추출된 아이템들을 몽고 DB에 저장
    store_mongoDB(keyword, prevUrl, currUrl, pageList, level, subkeyword)
...
# 몽고 DB에 각종 정보 저장
def store_mongoDB(keyword, prevUrl, currUrl, pageList, level, subkeyword):
    print("몽고 DB에 저장 중...")
    ...
    crawl_info = {
        ...
        "레벨": level,
        "서브 키워드": subkeyword,
        "현재 시간": datetime.datetime.utcnow(),
    }
